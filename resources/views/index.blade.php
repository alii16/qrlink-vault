      ...
      <div class="container">
        <div class="row gy-4 d-flex justify-content-between">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h2 data-aos="fade-up">Welcome To <br> <span style="color: #fad02c;">QR Code Generator</span></h2>
            <p data-aos="fade-up" data-aos-delay="100">Effortlessly generate your text or URL with ease!</p>

            <form id="qr-form" action="{{ route('generate-qr-code') }}" method="POST" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
              @csrf
              <div class="input-group">
                <span class="input-group-text">
                  <i class="fas fa-paperclip"></i>
                </span>
                <input type="text" class="form-control input-text" id="qr-input" name="qrCode" placeholder="Type something" required>
              </div>                                         
              <select id="size" name="size" class="form-control">
                <option selected disabled>⚙️ Custom size</option>
